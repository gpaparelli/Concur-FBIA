*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZCTE_T003_V
*   generation date: 08.12.2020 at 16:12:27
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZCTE_T003_V         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZCTE_T003_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZCTE_T003_V_EXTRACT
TOTAL = ZCTE_T003_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZCTE_T003_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZCTE_T003_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZCTE_T003_V_EXTRACT
TOTAL = ZCTE_T003_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZCTE_T003_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZCTE_T003_V'
...
TOTAL = ZCTE_T003_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZCTE_T003_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZCTE_T003_V-UPD_FLAG NE SPACE.
